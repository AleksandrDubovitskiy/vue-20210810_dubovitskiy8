<template>
  <fieldset class="agenda-item-form">
    ...
    <template v-for="agendaFormItem in agendaFormItems">
      <ui-form-group :label="agendaFormItem.label">
        <component
          :is="agendaFormItem.component"
          v-model="localAgendaItem[agendaFormItem.props.name]"
          v-bind="agendaFormItem.props"
          @[updateEvent]="$emit('update:agendaItem', localAgendaItem)"
        ></component>
      </ui-form-group>
    </template>
  </fieldset>
...
export default {
  ...
  computed: {
    ...
    updateEvent() {
      return agendaItemFormSchemas[this.localAgendaItem.type].component === 'ui-input' ? 'change' : 'click';
    },
  },
  watch: {
